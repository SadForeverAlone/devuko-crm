...
import { resizeImageFileToDataUrl } from "@/widgets/crm-app/model/resizeAvatarImage";
import {
  getCrmLocaleTag,
  getStatusClassName,
  getUserInitials,
...
import type { UsersSectionProps } from "@/shared/crm/ui/sectionTypes";
    ...
    return (
      ...
      >
        <article className="crm-panel crm-table-card">
          <div className="crm-users-search">
            <label htmlFor={userSearchInputId}>{ui.userSearchPlaceholder}</label>
            <input
