...
import { formatStoragePathLabel, getCrmLocaleTag } from "../../model/lib";
import {
  buildMonitorAlerts,
...
import { chartSeries, chartTimeLabels, seriesMaxValue, useMetricHistory } from "./useMetricHistory";
  ...
  return (
    <div className="crm-infra-meter">
      <div className="crm-infra-meter__track">
        <div
          className={`crm-infra-meter__bar crm-infra-meter__bar--${tone}`}
          style={{ width: `${width}%` }}
        />
      </div>
