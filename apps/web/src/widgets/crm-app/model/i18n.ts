...
export const crmCopy: Record<CrmLang, CrmCopy> = {
  ru: {
    ...
    crmLoginBack: "Назад",
    crmLoginCodeHint: "Код отправлен на {email}. Проверьте «Входящие» и «Спам». Код действует 10 минут.",
    crmLoginOtpSentToast: "Код отправлен на {email} (проверьте Спам, если письма нет)",
  ...
  en: {
    ...
    crmLoginBack: "Back",
    crmLoginCodeHint: "Code sent to {email}. Check Inbox and Spam. Valid for 10 minutes.",
    crmLoginOtpSentToast: "Code sent to {email} (check Spam if missing)",
